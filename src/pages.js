...
async function studyPage(req, res) {
    ...
    if(!filters.subject || !filters.weekday || !filters.time){
        ...
        return res.render("study-page.html", { filters, subjects, weekdays });
    }
    ...
    try {
        ...
        return res.render('study-page.html', { proffys, subjects, filters, weekdays })
...
module.exports = { pageLanding, studyPage, giveClassesPage, saveClasses }